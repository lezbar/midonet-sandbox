...
INDOCKER="docker exec mnsandboxlabv5_keystone_1"
KEYSTONE_IP=$(docker exec mnsandboxlabv5_keystone_1 hostname --ip-address)
NEUTRON_IP=$(docker exec mnsandboxlabv5_neutron_1 hostname --ip-address)
