...
INDOCKER="docker exec mnsandboxbcn33_keystone_1"
KEYSTONE_IP=$(docker exec mnsandboxbcn33_keystone_1 hostname --ip-address)
NEUTRON_IP=$(docker exec mnsandboxbcn33_neutron_1 hostname --ip-address)
...
docker exec mnsandboxbcn33_mariadb_1 mysql -u root -proot -e "set global max_connections = 100000;";
